...
| Theme | `agent/themes/neura-dark.json` | Near-black theme, accent `#7c9cff`, all 51 tokens |
...
- **Next — Phase 2 Part A**: MCP bridge via `@spences10/pi-mcp` — gfi-scout, paper, plan, Context7, Supabase (read-only), Notion. Blocked on tokens (env vars).
